...
class NavUtils{
  ...
  static Size get size => MediaQuery.of(MirrorflyUikit.instance.globalNavigatorKey!.currentContext!).size;
  ...
  static BuildContext get currentContext =>  MirrorflyUikit.instance.globalNavigatorKey!.currentContext!;
