...
class OTPPageStyle {
  OTPPageStyle({
    ...
    this.changeNumberTextStyle = const TextStyle(
        fontWeight: FontWeight.normal, color: Color(0xffFF0000), fontSize: 12),
    this.resendOtpTextStyle = const TextStyle(
        fontWeight: FontWeight.normal, color: Color(0xff181818), fontSize: 12),
  ...
  static final OTPTextFieldStyle _defaultOtpTextFieldStyle =
      OTPTextFieldStyle(otpFieldStyle: OtpFieldStyle());
}
