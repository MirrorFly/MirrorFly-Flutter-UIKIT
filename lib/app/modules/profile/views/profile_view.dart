    ...
    return FocusDetector(
      ...
      child: Scaffold(
          ...
          appBar: widget.enableAppBar
              ? AppBar(
                  title: Text(AppConstants.profileTitle, style: TextStyle(color: MirrorflyUikit.getTheme?.colorOnAppbar)),
                  centerTitle: true,
                                  ...
                                  onTap: () {
                                    if (controller.imagePath.value.checkNull().isNotEmpty) {
                                      ...
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (con) => ImageViewView(
                                                  imageName: controller.profileName.text, imagePath: controller.imagePath.value.checkNull())));
                                      ...
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (con) => ImageViewView(
                                                  imageName: controller.profileName.text, imageUrl: controller.userImgUrl.value.checkNull())));
                                    }
                                  },
                                );
                              }),
                        ...
                        return SizedBox(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(color: MirrorflyUikit.getTheme?.textSecondaryColor.withOpacity(0.7)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(() => ListTile(
                                ...
                                title: Text(
                                  controller.profileStatus.value.isNotEmpty ? controller.profileStatus.value : AppConstants.defaultStatus,
                                  style: TextStyle(
                                ...
                                onTap: () async {
                                  ...
                                  final result = await Navigator.push(
                                      context, MaterialPageRoute(builder: (con) => StatusListView(status: controller.profileStatus.value)));
                                  if (result != null) {
                        ...
                        () => ElevatedButton(
                          ...
                          child: Text(
                            /*controller.from.value == Routes.login
                                    ? 'Save'
                                    : */
                            controller.changed.value ? AppConstants.updateAndContinue : AppConstants.save,
                                ...
                                Helper.showAlert(
                                    ...
                                    actions: [
                                      ...
                                      TextButton(
                                          ...
                                          child:
                                              Text(AppConstants.remove.toUpperCase(), style: TextStyle(color: MirrorflyUikit.getTheme?.primaryColor)))
                                    ],
                                    context: context);
                              },
                              style: TextButton.styleFrom(
