...
import 'package:mirrorfly_uikit_plugin/app/modules/chat/views/chat_input_field.dart';
                  ...
                  Expanded(
                    child: Stack(
                      children: [
                        ...
                        Obx(() {
                          return controller.ableToScheduleMeet && !(controller.profile.isAdminBlocked.checkNull() || controller.profile.isBlocked.checkNull()||controller.isBlocked.value) && !controller.profile.isDeletedContact()&& controller.arguments!.isFloatingFabVisible ? FloatingFab(
                            fabTheme: chatStyle
