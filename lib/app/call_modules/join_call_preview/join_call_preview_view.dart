    ...
    return Container(
      ...
      child: Theme(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            child: Obx(() {
              return controller.callEnded.isEmpty
                  ? Column(
                      children: [
                        Stack(
                          children: [
                  ...
                  : linkErrorView(
                      callLinkErrorViewStyle: AppStyleConfig
                          .joinCallPreviewPageStyle.callLinkErrorViewStyle,
                      errorText: controller.callEndedMessage,
                      callEndedVisible: !controller.invalidLink);
            }),
          ),
        ),
      ),
      ...
      children: [
        ...
        Visibility(
          ...
          child: Padding(
            ...
            child: Text(
              getTranslated("callEnded"),
              style: callLinkErrorViewStyle.callEndedTextStyle,
            ),
          ),
        ),
        Text(
          errorText ?? getTranslated("noOneHere"),
