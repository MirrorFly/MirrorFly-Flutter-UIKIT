...
class GroupParticipantsView extends StatefulWidget {
  const GroupParticipantsView({super.key, required this.groupId, required this.callType});
...
class _GroupParticipantsViewState extends State<GroupParticipantsView> {
  ...
  void initState() {
    super.initState();
    controller.initGroupParticipantController(buildContext: context, groupId: widget.groupId, callType: widget.callType);
  }
