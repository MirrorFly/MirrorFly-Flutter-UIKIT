...
import 'package:mirrorfly_uikit_plugin/src/common/de_bouncer.dart';
import 'package:mirrorfly_uikit_plugin/src/common/session_management.dart';
import 'package:mirrorfly_uikit_plugin/src/common/permissions.dart';
...
class ChatController extends FullLifeCycleController
  ...
  void onInit() async {
    ...
    if (userJid.isEmpty) {
      ...
      await Mirrorfly.getProfileDetails(userJid,false).then((value) {
        debugPrint("getProfileDetails"+value.toString());
  ...
  void ready() {
    ...
    Member(jid: profile.jid.checkNull()).getProfileDetails()
